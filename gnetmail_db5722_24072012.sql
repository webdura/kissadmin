...
--
-- Host: localhost
-- Generation Time: Jul 24, 2012 at 06:51 AM
...
INSERT INTO `gma_admin_details` (`userId`, `fullName`, `theme_id`) VALUES
(1, 'GNet Admin', 1);
...
CREATE TABLE IF NOT EXISTS `gma_company` (
  ...
  `companyDiscount` float NOT NULL,
...
INSERT INTO `gma_company` (`companyId`, `companyName`, `companyVatNo`, `companyAccountEmail`, `companyAccountTel`, `companyAccountFax`, `companyAccountContact`, `companyBankName`, `companyBranchName`, `companyBranchNo`, `companyAccountName`, `companyAccountType`, `companyAccountNo`, `companyDiscount`, `status`, `ownerId`, `created`) VALUES
(1, 'Gnet Mail 1', 'companyVatNo', 'companyAccountEmail@gmail.com', 'companyAccountTel', 'companyAccountFax', 'companyAccountContact', 'companyBankName', 'companyBranchName', 'companyBranchNo', 'companyAccountName', 'companyAccountType', 'companyAccountNo', 25, 1, 1, 0);
...
(1, 4, 'site_logo_1.png', 'invoice_logo_1.png', 0, '#', '#A4FF54');
...
(1, 'Home Module', 1, 0, 1, 'dashboard.php', 'summary_btn', 1, 2, 'A,U'),
(2, 'Client Module', 1, 1, 1, 'users.php', 'clients_btn', 2, 2, 'A'),
(3, 'Quotation Module', 0, 1, 1, 'quotations.php', 'quotation_btn', 3, 2, 'A,U'),
(4, 'Invoice Module', 1, 1, 1, 'invoices.php', 'invoices_btn', 4, 2, 'A,U'),
(5, 'My Details', 1, 0, 1, 'myprofile.php', 'profile_btn', 9, 1, 'A,U'),
(6, 'Statement Module', 1, 1, 1, 'myaccount.php', 'statement_btn', 5, 2, 'A,U'),
(7, 'Payment Module', 1, 1, 1, 'payments.php', 'payment_btn', 6, 2, 'A,U'),
(8, 'Pricing Module', 1, 1, 1, 'pricing.php', 'pricing_btn', 7, 2, 'A,U'),
(9, 'Services', 1, 1, 1, 'services.php', '', 1, 1, 'A,U'),
(10, 'Admin Users', 1, 1, 1, 'admins.php', '', 3, 1, 'A,U'),
(11, 'Themes', 1, 0, 1, 'themes.php', '', 4, 1, 'A,U'),
(12, 'Companies', 0, 0, 1, 'company.php', '', 2, 1, 'A,U'),
(13, 'Terms', 1, 1, 1, 'accounts.php', '', 5, 1, 'A,U'),
(14, 'Messages', 1, 1, 1, 'emails.php', '', 6, 1, 'A,U'),
(15, 'Grading', 1, 1, 1, 'grading.php', '', 7, 1, 'A,U'),
(16, 'Manual Invoices & Statements', 1, 1, 1, 'send_invoices.php', '', 8, 1, 'A'),
(17, 'My Referrals', 1, 1, 1, '#', '', 1, 3, 'A');
...
--
-- Table structure for table `gma_send_invoices`
--

CREATE TABLE IF NOT EXISTS `gma_send_invoices` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `companyId` int(11) NOT NULL,
  `userId` int(11) NOT NULL,
  `title` varchar(100) NOT NULL,
  `invoicePath` varchar(50) NOT NULL,
  `createdDate` datetime NOT NULL,
  PRIMARY KEY (`id`)
);

--
-- Dumping data for table `gma_send_invoices`
--
...
--
-- Table structure for table `gma_send_invoice_details`
--

CREATE TABLE IF NOT EXISTS `gma_send_invoice_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sendInvoiceId` int(11) NOT NULL,
...
--
-- Dumping data for table `gma_send_invoice_details`
--
...
INSERT INTO `gma_theme` (`id`, `name`, `theme`, `head_color`, `default`) VALUES
(1, 'Blue', 'blue_theme', '#FFFFFF', 1),
(2, 'Cammo', 'cammo_theme', '#FFFFFF', 0),
(3, 'Green', 'green_theme', '#FFFFFF', 0),
(4, 'Orange', 'orange_theme', '#FFFFFF', 0),
(5, 'Paisley Royal', 'paisley_royal_theme', '#000000', 0),
(6, 'Pink Hearts', 'pink_hearts_theme', '#FFFFFF', 0),
(7, 'Pink Passion', 'pink_passion_theme', '#FFFFFF', 0),
(8, 'Retro 70''s', 'retro_70_theme', '#FFFFFF', 0);

-- --------------------------------------------------------

--
-- Table structure for table `gma_user_address`
--

CREATE TABLE IF NOT EXISTS `gma_user_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
...
--
-- Dumping data for table `gma_user_address`
--

INSERT INTO `gma_user_address` (`id`, `userId`, `address`, `city`, `province`, `zip`, `type`) VALUES
(1, 14, 'Address 1', 'Cochin', 'Kerala', '683561', 'B'),
(3, 14, 'Address 1', 'Cochin', 'Kerala', '683561', 'D'),
(4, 18, 'lkmklm asd', 'lkmklm', 'klm', 'kmklml', 'B'),
(5, 18, 'lkmklm bbb', 'lkmklm', 'klm', 'kmklml', 'D');
